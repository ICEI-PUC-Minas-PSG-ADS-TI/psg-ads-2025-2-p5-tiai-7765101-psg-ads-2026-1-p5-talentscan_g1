      ...
      <div className="nav-links">
        {!user ? (
          ...
          <>
            ...
            <Link to="/classificacao-compatibilidade">Classificação</Link>
            <Link to="/criador-cv">Criar Currículo</Link>

            <div className="nav-divider"></div>

            <Link to="/profile" className="profile-link">Perfil</Link>

            <Link to="/dashboard" className="btn-cta">Analisar Currículo</Link>
