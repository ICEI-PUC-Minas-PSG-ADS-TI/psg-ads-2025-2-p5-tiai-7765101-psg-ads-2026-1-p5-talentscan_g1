...
Desenvolver um sistema web capaz de realizar a análise de currículos utilizando Inteligência Artificial, auxiliando na identificação de informações importantes e oferecendo apoio no processo de avaliação de perfis profissionais.
